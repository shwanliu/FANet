...
class celebaData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(data['image'])
        image = self.trans(Image.open(data['image']))
...
def split_dataset(dataset, batch_size):
    ...
    train_loader = data.DataLoader(dataset, batch_size=batch_size, sampler=train_sample, num_workers=8)
    val_loader = data.DataLoader(dataset, batch_size=batch_size, sampler=validation_sample, num_workers=8)
